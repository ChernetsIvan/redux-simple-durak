...
class PlayerActionsHandler{
    ...
    static handleClickOnCard(
        cardID, playerCards, gameMode, playerField, aiField, trumpSuit, fullDeck, computerCards){
                ...
                if(element.id === cardID){
                    if(gameMode === gameModes.PlayerAttack){                    
                        ...
                        if( (playerField.length === 0) ||
                            FieldsUtils.isFieldsContainSuchCard(element, aiField, playerField)===true){                         
                    ...
                    if(gameMode === gameModes.PlayerDiscard){
                        ...
                        if(FieldsUtils.isFieldsContainSuchCard(element, aiField, playerField)===true){
                            playerField.push(element);                        
                            playerCards.splice(index, 1);                         
                        }
                        return false;
    ...
    static handleClickOnTakeButton(playerField, playerCards, aiField, fullDeck, computerCards, gameMode){
